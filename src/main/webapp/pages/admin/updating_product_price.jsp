...
<h1 style="text-align: center"><fmt:message key="title.update_product_price"/></h1>
<form action="${pageContext.request.contextPath}/controller?command=updating_product_price" method="post">
    ...
    <input type="text" name="newPrice" placeholder="<fmt:message key="placeholder.new_price"/>" size="35px"/><br>
    <input type="submit" value="<fmt:message key="button.update_price"/>"/>
</form>
