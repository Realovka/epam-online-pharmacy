...
<head>
    ...
    <title><fmt:message key="title.all_prepared_orders"/></title>
</head>
<body>

<jsp:include page="${pageContext.request.contextPath}/pages/static_part/header.jsp"/>

<h1><fmt:message key="title.all_prepared_orders"/></h1>

<c:choose>
    <c:when test="${sessionScope.listOrders.size()>0}">

        <p><fmt:message key="msg.click_on_order_id_if_need_realize"/></p>
