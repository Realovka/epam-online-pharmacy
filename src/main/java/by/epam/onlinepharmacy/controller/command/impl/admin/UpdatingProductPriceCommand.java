...
/**
 * The type Updating product price command.
 */
public class UpdatingProductPriceCommand implements Command {
    ...
    public CommandResult execute(HttpServletRequest request) {
        ...
        try {
            ...
            logger.log(Level.ERROR, "ServiceException in method execute while find list current products or update price of product", e);
