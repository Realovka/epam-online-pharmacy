...
<h1 style="text-align: center"><fmt:message key="title.update_pharmacy_house"/></h1>
<form action="${pageContext.request.contextPath}/controller?command=updating_pharmacy_house" method="post">
    ...
    <input type="text" name="newHouse" placeholder="<fmt:message key="placeholder.new_house"/>"/><br>
    <input type="submit" value="<fmt:message key="button.update_house"/>"/>
</form>
